...
function initializeDOMElements() {
    ...
    rawCanvas.setAttribute('width', 1280); // 640
    rawCanvas.setAttribute('height', 960); // 480
    ...
    astronaut.setAttribute('id', 'astronaut');
    astronaut.setAttribute('src', 'media/astronaut.png');
    astronaut.setAttribute('width', 210);
    astronaut.setAttribute('height', 400);
   // document.getElementById('simulation').addEventListener('webkitAnimationEnd', endAnimation);
    document.getElementById('simulation').appendChild(astronaut);
}
